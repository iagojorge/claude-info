...
(function () {
  ...
  const DEFAULT_CONFIG = {
    ...
    PDF_URL: 'https://drive.google.com/file/d/1GOab-FKBs0F8EQ2K6c8xBnt9Xu79xyFy/view?usp=sharing'
  };
  ...
  function initCountdown() {
    const STORAGE_KEY = 'mep_countdown_end';
    const HOURS = 2;
  ...
  function initLeadForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      localStorage.setItem('mep_lead', JSON.stringify(lead));
  ...
  function initCheckout() {
    ...
    form1.addEventListener('submit', function (e) {
      ...
      // Store
      localStorage.setItem('mep_checkout_data', JSON.stringify({
        name:  n.trim(),
        email: em.trim(),
        phone: ph.trim(),
        cpf:   cf.trim()
  ...
  window.processPayment = async function () {
    ...
    const rawData = localStorage.getItem('mep_checkout_data');
